...
<div class="container-fluid" style="margin-top: 1.5rem;">
    <div class="p-4 p-md-6 mb-4 text-white d-flex align-items-center rounded" style="background-color: #55595c; border-color: #55595c; margin-right: 1.5rem;">
            <div class="flex-grow-1 me-5">
                <h1 class="display-0 fst-italic">KATALOG PAKET</h1>
            ...
            <div class="flex-shrink-0">
                <img src="/assets/images/header_katalog_paket.jpg" alt="Deskripsi Gambar" class="img-fluid image-with-shadow" style="border-radius: 5%; height: 250px; width: 200px;">
            </div>
    </div>
